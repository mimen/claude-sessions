...
try {
  ...
  const baseline = {
    ...
    limitations: [
      ...
      "The ETag changed-snapshot samples commit title changes to the generated fixture only, then record the stale-trigger 304 separately from the next changed-visible 200 after the background rebuild completes.",
