...
function row(over: Partial<SessionRow> = {}): SessionRow {
  return {
    ...
    isSubagent: false, parentSessionId: null, resumeId: "resume-xyz", costUSD: 0, tokInput: 0, tokOutput: 0, tokCacheRead: 0, tokCacheWrite: 0, costByModel: {}, models: [], lastModel: "", userTurns: 0, tickIntervalSec: 0, ...over,
  };
}
