...
/**
 * Vendored from Coss UI Preview Card.
 * Source: https://github.com/cosscom/coss/blob/11c7e426b7adea2c821991be3c7c26c42abb7b02/packages/ui/src/components/preview-card.tsx
 */
...
export function PreviewCardPopup({
  ...
  readonly anchor?: PreviewCardPrimitive.Positioner.Props["anchor"];
  readonly portalProps?: PreviewCardPrimitive.Portal.Props;
}): React.ReactElement {
  return (
