...
const row = (o: Partial<CatalogueRow>): CatalogueRow => ({
  ...
  skill: null, role: null, resumeCommand: null, project: null, system: "pr-watch", gusWork: null, workUnitId: null, epicId: null, phase: null, statusLine: null, miladReview: null, buildComplete: false, stage: null, activity: null, notes: null, updatedAt: null,
