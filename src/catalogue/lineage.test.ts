...
function row(over: Partial<CatalogueRow>): CatalogueRow {
  return {
    ...
    skill: null, role: null, resumeCommand: null, project: null, system: "pr-watch", gusWork: null,
    epicId: null, phase: null, notes: null, updatedAt: null, prNumber: null, prRepo: null,
...
test("predecessorsOf: an unkeyed row has no lineage", () => {
  const rows = new Map<string, CatalogueRow>([["u", row({ sessionId: "u", role: null, system: null })]]);
