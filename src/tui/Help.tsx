...
const KEYS: Array<[string, string]> = [
  ...
  [":", "codex: reorganize metadata across all sessions (natural language)"],
  ["e", "codex: edit the selected session's metadata (natural language)"],
  ["esc", "clear search filter, then quit"],
  ["s", "cycle sort: recency → cost → messages"],
  ["g", "cycle view: groups → by-state → flat → tree"],
