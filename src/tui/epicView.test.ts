...
const cat = (o: Partial<CatalogueRow>): CatalogueRow => ({
  ...
  role: null, resumeCommand: null, project: null, cluster: null, gusWork: null, workUnitId: null, groupingId: null, statusLine: null, meta: {}, stage: null, activity: null, notes: null,
...
test("buildEpicView: groups system members by epic, strips team prefix, no-epic last, excludes no-system", () => {
  const catMap = new Map<string, CatalogueRow>([
    ["a", cat({ sessionId: "a", cluster: "pr-watch", groupingId: "E1" })],
    ["b", cat({ sessionId: "b", cluster: "pr-watch", groupingId: "E1" })],
    ["c", cat({ sessionId: "c", cluster: "pr-watch", groupingId: null })], // no epic
