...
function row(id: string, root: string, name: string): SessionRow {
  return {
    ...
    title: id, titleSource: "fallback", isSubagent: false, parentSessionId: null, resumeId: id, costUSD: 0, tokInput: 0, tokOutput: 0, tokCacheRead: 0, tokCacheWrite: 0, costByModel: {}, models: [], lastModel: "", userTurns: 0, tickIntervalSec: 0,
  };
}
