...
function row(over: Partial<CatalogueRow>): CatalogueRow {
  return {
    ...
    system: null, gusWork: null, workUnitId: null, epicId: null, phase: null, statusLine: null, miladReview: null, buildComplete: false, stage: null, activity: null, notes: null, updatedAt: null,
