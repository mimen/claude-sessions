...
function role(over: Partial<RoleDef>): RoleDef {
  return {
    ...
    resumeCommand: null, stageSchema: null, pinOnResume: false, color: null, model: null, permissionMode: null, manifestError: null, skills: [], commands: [], hooks: [], updatedAt: null, ...over,
  };
}
